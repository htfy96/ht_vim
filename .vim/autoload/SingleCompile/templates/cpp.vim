...
function! SingleCompile#templates#cpp#Initialize()
    ...
    call SingleCompile#SetCompilerTemplateByDict('cpp', 'g++', {
                ...
                \ 'vim-compiler': 'gcc'
                \})
    call SingleCompile#SetCompilerTemplate('cpp', 'ccache g++',
                \'CCache GNU C++ Compiler', 'ccache', ' g++ -g -std=c++11 -o $(FILE_TITLE)$',
                \g:SingleCompile_common_run_command)
    call SingleCompile#SetCompilerTemplateByDict('cpp', 'ccache g++', {
                \ 'pre-do'  : function('SingleCompile#PredoGcc'),
                \ 'out-file': g:SingleCompile_common_out_file,
                \ 'priority' : 2,
                \ 'vim-compiler': 'ccache g++'
                \})
 ...
 call SingleCompile#SetCompilerTemplate('cpp', 'ccache clang',
                 \ 'ccache the Clang C and Objective-C compiler',
                 \'ccache', ' clang++ -std=c++11 -g  -o $(FILE_TITLE)$   -lm ', g:SingleCompile_common_run_command)
     call SingleCompile#SetCompilerTemplateByDict('cpp', 'ccache clang', {
                     \ 'pre-do'  : function('SingleCompile#PredoClang'),
                     \ 'out-file': g:SingleCompile_common_out_file,
                     \ 'vim-compiler': 'ccache clang',
                        \ 'priority': 1
                     \})
