...
syn keyword typeKeyword near far short byte db dword word dw dd equ
...
syn keyword asmKeyword	int into invd invlpg invlpga in iretd jle 
...
syn keyword asmKeyword	ltr mfence movmskpd movmskps not out 
...
" R-T
syn keyword asmKeyword	rdmsr rdpmc rdtsc rsm sahf retf repe
...
syn keyword asmKeyword	wbinvd wrmsr xchg times
...
if version >= 508 || !exists("did_asmx86_64_syntax_inits")
  ...
  HiLink        typeKeyword     Type
  HiLink        asmLabel        Label

  HiLink        asmStr          String 
